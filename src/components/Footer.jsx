  ...
  return (
    <footer className="site-footer">
      ...
      <style>{`
        ...
        .footer-brand .logo-text { color: #f9fafb; font-size: 1.125rem; }
        ...
        .footer-col a { font-size: .875rem; color: #9ca3af; transition: color var(--t-fast); }
        ...
        .footer-bottom-links a { color: #6b7280; font-size: .8rem; }
        .footer-bottom-links a:hover { color: #818cf8; }
